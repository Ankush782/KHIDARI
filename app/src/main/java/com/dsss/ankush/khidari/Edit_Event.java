...
public class Edit_Event extends AppCompatActivity {
   ...
   // Event e;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        n=(Button)findViewById(R.id.name_edit_event_change);
        n.setText("Edit");
//        Toolbar toolbar=(Toolbar)findViewById(R.id.toolbar_all);
//        toolbar.setTitle("  Edit");
//        setSupportActionBar(toolbar);
        e=(Event)getIntent().getSerializableExtra("events");
        p_name=e.name;
        ...
        sports.setText(e.sports);
        date.setText(e.date);
        time.setText(e.time);
        state.setText(e.state);
        city.setText(e.city);
        address.setText(e.address);
        note.setText(e.notes);
        a.setText(e.istprize);
        b.setText(e.istrunnerup);
        c.setText(e.secondrunnerup);
        fee.setText(e.fee);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog=new DatePickerDialog(Edit_Event.this,0);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(verify())
                {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("All_Events").child(p_name).setValue(e).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            FirebaseDatabase.getInstance().getReference().child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Events").child(p_name).setValue(e).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
